...
import { EmotionButton } from '@/components/EmotionTest/EmotionStyledButton';
import { EmotionDiv } from '@/components/EmotionTest/EmotionStyledDiv';
import { EmotionContainer } from '@/components/EmotionTest/EmotionContainer';
import StyledButton from '@/components/EmotionTest/styledButton';


  //! my landingPageLoader function
// is responsible for calling the landing page function 
